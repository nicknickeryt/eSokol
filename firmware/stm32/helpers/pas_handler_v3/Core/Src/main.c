...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, REAR_LED_Pin | THR_SWITCH_Pin | THR_DIS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : REAR_LED_Pin THR_SWITCH_Pin THR_DIS_Pin */
  GPIO_InitStruct.Pin = REAR_LED_Pin | THR_SWITCH_Pin | THR_DIS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
